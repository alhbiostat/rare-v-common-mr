...
Restricting to those protein exposures that show signficiant causal effects on a given outcome (at p <= `r alpha` with >= 5 IVs), and significant heterogenity between rare and common variant IV sets (at P(FDR) < 0.05):
